<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
            ...
            <div class="flex">
                ...
                <div class="nav">
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        ...
                        <x-jet-nav-link href="{{ route('Compare') }}" :active="request()->routeIs('Compare')">
                            {{ __('Comparison list') }} @livewire('compare-count')
                        </x-jet-nav-link>
                        <x-jet-nav-link href="{{ route('Order') }}" :active="request()->routeIs('Order')">
                            {{ __('Request datasheets') }} @livewire('request-count')
                        </x-jet-nav-link>
                    </div>
                </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-jet-responsive-nav-link href="{{ route('Compare') }}" :active="request()->routeIs('Compare')">
                {{ __('Comparison list') }} @livewire('compare-count')
            </x-jet-responsive-nav-link>
